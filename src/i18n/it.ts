...
export const it = {
  ...
  signature: {
    title: 'Firma',
    add: 'Aggiungi firma',
    new: 'Crea una nuova firma',
    signHere: 'Firma qui',
    signHereFor: (label: string) => `Firma qui: ${label}`,
    legal:
      'Questa è una firma grafica. Non sostituisce la firma digitale qualificata richiesta per alcuni documenti ufficiali.',
    withDate: 'Aggiungi la data di oggi accanto alla firma',
    count: (n: number) => (n === 1 ? '1 firma nel documento.' : `${n} firme nel documento.`),
    help: 'Trascina la firma per spostarla e l’angolo per ridimensionarla. Da tastiera: frecce per spostare, Alt+frecce per ridimensionare, Canc per eliminare.',
    placedLabel: (page: number) => `Firma a pagina ${page}`,
    remove: 'Elimina la firma',
    current: 'Firma pronta da inserire',
    // Dialog
    dialogTitle: 'Crea la tua firma',
    tabs: { draw: 'Disegna', image: 'Da immagine', type: 'Scrivi' },
    color: 'Colore',
    black: 'Nero',
    blue: 'Blu',
    drawHint: 'Firma qui dentro con il mouse, il touchpad o il dito.',
    drawArea: 'Area per disegnare la firma',
    clear: 'Cancella',
    chooseImage: 'Scegli una foto o una scansione (PNG o JPG)',
    imageHint: 'Meglio una foto su carta bianca, con buona luce. Lo sfondo viene tolto.',
    threshold: 'Rimozione dello sfondo',
    thresholdLess: 'meno',
    thresholdMore: 'di più',
    imagePreview: 'Anteprima della firma senza sfondo',
    imageError: 'Non è stato possibile leggere l’immagine. Prova con un file PNG o JPG.',
    nameLabel: 'Nome e cognome',
    style: 'Stile',
    styles: {
      caveat: 'Scrittura a mano',
      'dancing-script': 'Corsivo morbido',
      'great-vibes': 'Calligrafico',
      sacramento: 'Tratto sottile',
    } as Record<string, string>,
    remember: 'Ricorda la mia firma su questo dispositivo',
    rememberHint: 'Resta solo in questo browser. Puoi eliminarla quando vuoi.',
    saved: 'Firma salvata su questo dispositivo',
    useSaved: 'Usa la firma salvata',
    deleteSaved: 'Elimina la firma salvata',
    deleted: 'Firma salvata eliminata da questo dispositivo.',
    use: 'Usa questa firma',
    cancel: 'Annulla',
    empty: 'La firma è vuota.',
  },
  history: {
    undo: 'Annulla',
    redo: 'Ripeti',
